...
- (SRShortcut *)transformedValue:(NSString *)aValue
{
    ...
    {
        os_log_error(SR_LOG_DEFAULT, "#Error unexpected key symbol");
//        os_log_error(SR_LOG_DEFAULT, "#Error unexpected key symbol");
        return nil;
    }
...
- (NSString *)reverseTransformedValue:(SRShortcut *)aValue
{
    ...
    {
        os_log_error(SR_LOG_DEFAULT, "#Error invalid class of the value");
        return nil;
    }
    ...
    if (!keyCodeSymbol)
    {
        os_log_error(SR_LOG_DEFAULT, "#Error unexpected key code");
        return nil;
    }
